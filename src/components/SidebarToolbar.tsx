...
//       {/* כפתורים נוספים: חזרה לדף קודם ומאפייני קבוצה */}
//       <div className="flex flex-col gap-2 w-full items-center mt-2 md:mt-4">
//         {/* חזרה לדף הקודם */}
//         <button
//           onClick={() => window.history.back()}
//           className="bg-white/10 rounded-full w-11 h-11 flex items-center justify-center hover:bg-white/20 transition"
    ...
    <>
      <aside className="fixed top-0 bottom-0 right-0 w-16 md:w-20 lg:w-24 rounded-2xl bg-brand-900 text-white flex flex-col items-center p-3 gap-4 z-40 shadow-card">
        ...
        <div className="w-full flex flex-col items-center gap-1 pb-2">
          ...
          <div className="text-[10px] text-white/60 text-center">{groupLabel}</div>
        </div>
      </aside>

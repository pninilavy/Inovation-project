...
//   const [current, setCurrent] = useState(2); // התמונה האמצעית בהתחלה
...
//   // החישוב של חמשת התמונות שמוצגות כרגע
...
//   return (
//     <div className="min-h-screen bg-white flex flex-col items-center justify-center relative overflow-hidden rtl text-gray-800">
...
//             const isCenter = i === 2; // התמונה האמצעית מתוך 5
//             return (
//               <img
//                 key={i}
//                 src={src}
